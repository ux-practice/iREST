...
const CreateMock = props => {
  ...
  useEffect(() => {
    if ((isSchema && values.serviceResponseType === "default") && initialSchemaState && pagetitle !== 'Create Mock') {
        ...
        <div className="row mock-card" data-testid="row">
          <form onSubmit={handleSubmit} className="form-width" data-testid="handleSubmit">
            ...
            <div style={props.values.mockId || isFullFormDisplay ? {} : {display: 'none'}}>
              ...
              {isSchema && (props.values.serviceResponseType === "default") ? (
                <>
                <SchemaView
                  values={values}
                  errors={errors}
                  ...
                  <Accordion.Collapse eventKey="0">
                    <Card.Body>
                      {allowedSaveMethodEditor.map((schemaType) => {
                        ...
                        } else if ((schemaType === 'GET_BY_ID') && (typeof editorBodyText === "object") && (schemaType in editorBodyText)) {
            ...
            <div style={props.values.mockId || isFullFormDisplay ? {} : {display: 'none'}}>
              ...
              <div className="d-flex justify-content-start mr-2">
                ...
                {values.serviceResponseType === serviceResponseType.SAVE ? <> </> : <button
                  type="button"
