...
const {PREVIEW_MOCK_MODEL} = modelList
...
module.exports = (sequelize, DataTypes) => {
    const TempMock = sequelize.define(PREVIEW_MOCK_MODEL, {
        _id: {
            type: Sequelize.UUID,
        ...
        referenceId: {type: Sequelize.UUID, references: {model: "TempMocks", key: '_id'}},
        ...
        mockName: {type: DataTypes.STRING, allowNull: false},
